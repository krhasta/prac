            ...
            <div id="chart-interFace" class="white-div flex s-bet p-rel">
                <div class="flex s-bet h100">
                    <div class="flex flex-colm h100">
                        <h3 class="ticker-cont m0 w100" style="justify-content:left"><span
                                class="ticker"></span><br><span id="timer" class="font16"></span>
                        </h3>
                        <div id="chart" class="flex flex-colm"
                    ...
                    <div id="stock-order">
                        <h3 class="m0 mb20">잔고: KRW
                            <span id="balance"></span> <br><span id="balanceProfit" class="font16">&nbsp;</span>
                        </h3>
                        <div id="sp-sq" class="flex flex-colm vw15">
                            ...
                            <div class="gray-box w100">
                                ...
                                <p class="m0">주문금액:&nbsp;KRW&nbsp;<span id="price"></span></p>
                            </div>
                        </div>
